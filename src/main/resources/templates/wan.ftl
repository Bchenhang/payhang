...
<iframe id="geoPage" width="100%" height="30%" frameborder=0 scrolling="no" src="https://apis.map.qq.com/tools/geolocation?key=4AZBZ-6JKK2-CYCUA-CWELH-LO4WZ-47BXF&referer=myapp&effect=zoom"></iframe>
    ...
    window.addEventListener('message', function(event) {
        ...
        if(loc && loc.module =="geolocation") { //定位成功,防止其他应用也会向该页面post信息，需判断module是否为'geolocation'
            var markUrl = 'https://apis.map.qq.com/tools/poimarker' +
                    ...
                    '&key=4AZBZ-6JKK2-CYCUA-CWELH-LO4WZ-47BXF&referer=myapp';
            //给位置展示组件赋值
