...
<header data-am-widget="header" class="am-header am-header-default jz" style="background-color: #f2f2f2">
    ...
    <h1 class="am-header-title">
        <a href="#title-link" class="" style="color: #333333">考勤记录</a>
    </h1>
    <div class="section">
    ...
    <div align="center">
        <input type="button" class="login-button" value="查  询" onclick="clickBind()" style="width: 120px; height: 30px;BORDER-RIGHT: #7b9ebd 1px solid; BORDER-TOP: #7b9ebd 1px solid;BORDER-LEFT: #7b9ebd 1px solid; BORDER-BOTTOM: #7b9ebd 1px solid;background-color:#1465f8;color: #f2f2f2 "/>
    </div>
</header>
<#---->
    <div class="pan_list" data-toggle="large">
        <!--展示上拉加载的数据列表-->
        <div class="cp_dtl_list" id="div_id"  style="padding-top: 140px">
